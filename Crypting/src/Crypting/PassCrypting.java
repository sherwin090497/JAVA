		...
		public static void main(String[] args) {
	        ...
	        for(int i = 1; i != 0; i++) {
	        	...
	        	if (Letter.contentEquals("E")) {
	                ...
	                for (int j = 0; j < 2; ++j) {
	                	encryptMessage = PassCrypting.encrypt(encryptMessage, secretKey);
	                }
	                String encryptedString = PassCrypting.encrypt(encryptMessage, secretKey);	
	                System.out.print("\nEncrypted message:  ");
		            ...
		            for (int j = 0; j < 2; ++j) {
		            	decryptMessage = PassCrypting.decrypt(decryptMessage, secretKey);
		            }
		            String decryptedString = PassCrypting.decrypt(decryptMessage, secretKey);
		            System.out.print("\nDecrypted message:  ");
