...
public class SortingTest<E> implements Sorting<E> {
	...
	public static void testInput(int num) {
		...
		System.out.println("Insertion Sort \t\t " + insertionTime + " nanoseconds\t " + milliinsertionTime + " milliseconds");
		...
		System.out.println("Reverse Insertion Sort   " + reverseInsertionTime + " nanoseconds\t " + millireverseInsertionTime + " milliseconds");
		System.out.println("Reverse Quick Sort \t " + reverseQuickTime + " nanoseconds\t " + millireverseQuickTime + " milliseconds");
		System.out.println("Reverse Merge Sort \t " + reverseMergeTime + " nanoseconds\t " + millireverseMergeTime + " milliseconds");
	}
	...
	private void reversedMerge(LinkedList<E> list, int low, int midLow, int midHigh, int high, LinkedList<E> secondList) {
		// TODO Auto-generated method stub
		int i = low;
		int j = midLow;
		int k = midHigh;
