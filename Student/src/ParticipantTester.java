public class ParticipantTester {
	...
	public static void testDefaultConstructor() {
		...
		if (participant.getName().equals(defaultName)) { // TEST #0
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println("\tReason: " + participant.getName() + " is incorrect, the default name should be "
					+ defaultName + "\n");
			numFailed++;
		}

		System.out.println("Test #" + testNumber++ + ": Testing correct default weight using the getWeight method\n");
		if (participant.getWeight() == defaultWeight) { // TEST #1
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println("\tReason: " + participant.getWeight()
					+ " is incorrect, the default weight should be defaultWeight\n");
			numFailed++;
		}

		System.out.println("Test #" + testNumber++ + ": Testing correct default height using the getHeight method\n");
		if (participant.getHeight() == defaultHeight) { // TEST #2
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println("\tReason: " + participant.getHeight() + " is incorrect, the default height should be "
					+ defaultHeight + "\n");
			numFailed++;
		}

		System.out.println("Test #" + testNumber++ + ": Testing the getBMI method on the first participant\n");
		if (Math.abs(participant.getBMI() - defaultBMI) < 0.01) { // TEST #3
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println("\tReason: " + participant.getBMI() + " is incorrect, the default BMI should be "
					+ defaultBMI + "\n");
			numFailed++;
		}
	}
	...
	public static void testSetters() {
		...
		Participant participant = new Participant(); // TEST #4

		participant.setName("Sally Jane");
		System.out.println(
				"Test #" + testNumber++ + ": Testing setName(\"Sally Jane\") method using the getName method\n");
		if (participant.getName().equals("Sally Jane")) { // TEST #5
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println(
					"\tReason: " + participant.getName() + " is incorrect, the updated name should be Sally Jane\n");
			numFailed++;
		}

		participant.setWeight(100);
		System.out.println("Test #" + testNumber++ + ": Testing setWeight(100) method using the getWeight method\n");
		if (participant.getWeight() == 100) { // TEST #6
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println(
					"\tReason: " + participant.getWeight() + " is incorrect, the updated weight should be 100\n");
			numFailed++;
		}

		participant.setHeight(5.0);
		System.out.println("Test #" + testNumber++ + ": Testing setHeight(5.0) using the getHeight method\n");
		if (participant.getHeight() == 5.0) { // TEST #7
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println(
					"\tReason: " + participant.getHeight() + " is incorrect, the updated height should be 5.0\n");
			numFailed++;
		}

		System.out.println("Test #" + testNumber++
				+ ": Testing the getBMI method on the first participant after changing weight and height\n");
		if (participant.getBMI() == 2812.0) { // TEST #8
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out
					.println("\tReason: " + participant.getBMI() + " is incorrect, the default BMI should be 2812.0\n");
			numFailed++;
		}
	}

	/**
	 * Method to test the single argument Participant constructor, which takes in
	 * only the name of the participant.
	 */
	public static void testSingleParamConstructor() {
		...
		if (participant2.getName().equals("Sean Connery")) { // TEST #9
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println(
					"\tReason: " + participant2.getName() + " is incorrect, the name should be Sean Connery\n");
			numFailed++;
		}

		System.out.println("Test #" + testNumber++ + ": Testing correct default weight using the getWeight method\n");
		if (participant2.getWeight() == defaultWeight) { // TEST #10
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println("\tReason: " + participant2.getWeight() + " is incorrect, the default weight should be "
					+ defaultWeight + "\n");
			numFailed++;
		}

		System.out.println("Test #" + testNumber++ + ": Testing correct default height using the getHeight method\n");
		if (participant2.getHeight() == defaultHeight) { // TEST #11
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println("\tReason: " + participant2.getHeight() + " is incorrect, the default height should be "
					+ defaultHeight + "\n");
			numFailed++;
		}

		System.out.println("Test #" + testNumber++ + ": Testing the getBMI method on the second participant\n");
		if (Math.abs(participant2.getBMI() - defaultBMI) < 0.01) { // TEST #12
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println("\tReason: " + participant2.getBMI() + " is incorrect, the default BMI should be "
					+ defaultBMI + "\n");
			numFailed++;
		}
	}
	...
	/**
	 * Method to test the three argument Participant constructor, which takes in the
	 * name, height, and weight of the participant.
	 */
	public static void testThreeParamConstructor() {
		...
		if (participant3.getName().equals("Alex Baldwin")) { // TEST #13 - TEST #18
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println(
					"\tReason: " + participant3.getName() + " is incorrect, the name should be Alex Baldwin\n");
			numFailed++;
		}

		System.out.println("Test #" + testNumber++ + ": Testing correct weight using the getWeight method\n");
		if (participant3.getWeight() == 150) { // TEST #14 - TEST #19
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
		...
		if (participant3.getHeight() == 5.0) { // TEST #15 - TEST #20
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
		...
		if (participant3.getBMI() == 4218.0) { // TEST #16 - TEST #21
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println(
					"\tReason: " + participant3.getBMI() + " is incorrect, the default BMI should be 4218.0\n");
			numFailed++;
		}
	...
	public static void testNegatives() {
		...
		System.out.println();
		if (participant4.getHeight() == defaultHeight) { // TEST #23
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println("\tReason: " + participant4.getHeight() + " is incorrect, the height should be "
					+ defaultHeight + "\n");
			numFailed++;
		}
		...
		if (participant4.getWeight() == 100) { // TEST #24
			System.out.println();
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
		...
		System.out.println();
		if (participant5.getWeight() == defaultWeight) { // TEST #25
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
			System.out.println("\tReason: " + participant5.getWeight() + " is incorrect, the weight should be "
					+ defaultWeight + "\n");
			numFailed++;
		}
		...
		System.out.println();
		if (participant5.getHeight() == 5.0) { // TEST #26
			System.out.println("\tTest PASSED!\n");
			numPassed++;
		} else {
			System.out.println("\tTest FAILED!\n");
